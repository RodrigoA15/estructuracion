...
<html lang="en">
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="#"><img src="../../imagen/Logo1.png" width="70" height="70" alt="Hotel y Restaurante Popayan"></a>
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="#">Iiniciar Reserva</a></li>
    ...
    <!-- pie de pagina-->
  <footer>
  <center>Copyright 2022 Version1.1</center>
